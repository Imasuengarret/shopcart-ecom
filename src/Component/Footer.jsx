...
const desc =
  "Michigan theme number one world class university in the world There are student are studing always in this university for all time.";
...
function Footer() {
  ...
  return <footer className="style-2">
    ...
    <div className="footer bottom">
        <div className="container">
            <div className="section-wrapper flex justify-around">
                <p>&copy; {currentYear}-{currentMonth}-{currentDate} <Link to="/">Shop Cart</Link> Designed by <a href="/" target="_blank">GARRET</a></p>
